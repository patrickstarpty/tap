...
async def test_fixture_cli_publish_defaults_to_strict_committed_vectors() -> None:
    ...
    assert args.fixture == Path("apps/tap-ai-backend/tests/fixtures/milvus/doc-fixture-v1.json")
    assert args.queries == Path("apps/tap-ai-backend/tests/fixtures/milvus/query-cases-v1.json")
...
async def test_makefile_scopes_real_milvus_gate_and_uses_committed_snapshot() -> None:
    ...
    assert (
        "--vectors apps/tap-ai-backend/tests/fixtures/milvus/vectors-research-embedding-v1.json"
    ) in makefile
...
args = argparse.Namespace(
    command='publish',
    fixture=Path('apps/tap-ai-backend/tests/fixtures/milvus/doc-fixture-v1.json'),
