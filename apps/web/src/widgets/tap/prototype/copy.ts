...
export const PROTOTYPE_COPY = {
  en: {
    ...
    chat: {
      ...
      noContextNotice:
        "Select relevant knowledge sources to get an answer with citations.",
      selectedContextNotice:
        "Review the selected sources and citations for this answer.",
    ...
    sources: {
      ...
      description: "Choose what Tapper can use.",
      ...
      immutableRevision: "Published version",
      knowledgeSource: "Knowledge source",
      knowledgeBaseDocument: "Knowledge base document",
      pageLocalSource: "Library source",
    ...
    library: {
      ...
      localSourceDescription: "Library source",
    ...
    testManagement: {
      ...
      importedFromTapper: "Imported from Tapper",
    ...
    lowCode: {
      ...
      description: "Generated by Tapper · Playwright · Draft",
      ...
      emptyDescription:
        "Ask Tapper to generate an automation, then open that draft here to edit its steps.",
      startInTapper: "Start in Tapper",
  ...
  zh: {
    ...
    testManagement: {
      ...
      testData: "测试数据",
      searchPlans: "搜索测试计划",
      importedFromTapper: "从 Tapper 导入",
    ...
    lowCode: {
      heading: "寿险投保申请自动化",
      description: "由 Tapper 生成 · Playwright · 草稿",
      saveDraft: "保存草稿",
      saved: "已保存",
      ...
      emptyTitle: "还没有自动化草稿",
      emptyDescription:
        "请先让 Tapper 生成自动化流程，再把草稿打开到这里编辑步骤。",
      startInTapper: "前往 Tapper",
