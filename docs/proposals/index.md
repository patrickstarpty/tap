...
- [RFC-006：Athena 本地可选 Codex CLI 回答后端](2026-08-31-rfc-006-athena-local-codex-answer-backend.md)（`accepted`）：拆分 Embedding/回答端口，保持百炼向量空间，并为单机 Demo 增加受限、显式选择的 Codex 回答路径与模型链路诊断。
