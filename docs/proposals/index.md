...
- [RFC-007：Phase 1 Intelligence Layer 探索](2026-09-02-rfc-007-phase-1-intelligence-layer-exploration.md)（`in-review`）：提议先用可选资料、仓库与失败材料验证可追溯的 AI 理解、自动化设计、长期任务、候选工程和 Review Package，再建设 BrowserStack-like 测试平台主体。
