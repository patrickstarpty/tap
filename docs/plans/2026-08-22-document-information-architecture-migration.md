...
- [ ] **Step 2: Create the normative governance document**
...
- [ ] **Step 2: Move the 11 intact documents with Git**
...
- [ ] **Step 3: Split `decisions.md` without losing text**
...
- [ ] **Step 4: Repair every repository-local link**
...
- [ ] **Step 5: Create direct-child indexes**
...
- [ ] **Step 6: Update the repository guide**
...
- [ ] **Step 7: Verify the migrated unit and commit**
...
- [ ] **Step 1: Validate inventory, names, IDs, states, links, and anchors**
...
- [ ] **Step 3: Close the lifecycle records**
...
- [ ] **Step 4: Commit final status and verify clean state**
