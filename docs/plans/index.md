...
- [Tapper 知识与 Web 自动化平台实施计划](2026-09-04-tapper-knowledge-web-automation-platform.md)（`planned`，当前）：按 TDD 分解 V0 Validation Scope、V1 Knowledge、V2 Graph、V3 Test Design、V4 Web LCA/Recorder、V5 Jenkins、VG、P0 和 P1。
...
- [Tapper 品牌与运行命名空间迁移实施计划](2026-09-05-tapper-brand-namespace-migration.md)（`active`）：按 clean cut 迁移 TAP/Tapper 品牌、Web/Backend/运行标识、治理文档、图表及 40 张客户截图，并以零残留与完整回归门禁收口。
