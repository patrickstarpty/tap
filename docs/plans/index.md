...
- [Milvus 本地检索实验实施计划](2026-08-24-milvus-local-search-experiment.md)（`planned`）：以本地 Docker、脱敏 `doc` fixture、provider-neutral adapter 和真实 ACL/alias 门禁验证 Milvus 路径。
