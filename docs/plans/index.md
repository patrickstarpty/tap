...
- [Athena 本地 Codex 回答后端实施计划](2026-08-31-athena-local-codex-answer-backend.md)（`planned`）：修复 Embedding/ingestion 诊断，拆分向量与回答端口，并在保留百炼跨语言向量空间的同时交付受限、可选的本机 Codex CLI 回答路径。
