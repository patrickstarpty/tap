...
仓库已从最初的本地知识切片和纯前端原型推进到 V3 Gate 通过：

- V0、V1、V2、V3 Gate Review 已通过；真实 Project-scoped Source、Conversation/SSE、Milvus、Knowledge Graph、Citation、Test Plan 和 Web 接线均已交付。
- V3 Task 15–17 已完成；[`QUALITY-TEST-01`](../reviews/2026-09-14-v3-ai-test-design-gate.md) 通过真实模型、完整回归和隔离 E2E，V4 可开始。
...
[Task 11–14](2026-09-04-tapper-knowledge-web-automation-platform.md#v2--grounded-knowledge-graph) 已完成；[V2 Gate Review](../reviews/2026-09-13-v2-knowledge-graph-gate.md)通过真实百炼 Graph、200 条人工判断、完整回归和隔离 E2E，V2 出口完成。
...
[Task 15–17](2026-09-04-tapper-knowledge-web-automation-platform.md#v3--ai-test-design) 已完成；[V3 Gate Review](../reviews/2026-09-14-v3-ai-test-design-gate.md)通过真实百炼 Test Design、50 个业务意图、完整回归和隔离 E2E，V3 出口完成，V4 可开始。
