...
[Task6 内部Source账本](../reviews/2026-09-06-tapper-v1-source-ledger-review.md)已完成验收；当前推进Source API/Picker与canonical Milvus。查询脱敏与search-attempt Audit不等同于完整模型治理或QUALITY-KB-01通过。
