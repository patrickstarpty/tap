...
- [ADR-028：LangGraph 作为统一 Chat Orchestrator](2026-09-18-adr-028-langgraph-unified-chat-orchestrator.md)（`superseded`）：由 ADR-029 替代；统一图和稳定端口保留，原两路径模型扩展为 Fast Chat、Durable Workflow、Bounded Agentic Task。
