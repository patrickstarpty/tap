...
export LITELLM_MODEL='openai/e2e-chat-unused'
export LITELLM_EMBEDDING_MODEL='openai/e2e-embedding-unused'
export OPENAI_API_KEY='tap-e2e-unused'
export LITELLM_EMBEDDING_API_KEY='tap-e2e-unused'
export LITELLM_EMBEDDING_API_BASE='http://127.0.0.1:14000'
...
readonly LITELLM_MODEL LITELLM_EMBEDDING_MODEL OPENAI_API_KEY
readonly LITELLM_EMBEDDING_API_KEY LITELLM_EMBEDDING_API_BASE MILVUS_URI
